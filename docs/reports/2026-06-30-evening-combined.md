COMBINED EVENING BRIEF (session close) â€” 2026-06-30 19:00
...
=== ST MARKS PHARMACY (STMARKS-WEB) ===
  ...
  - Pharmacist (Dr D Shah / superintendent) must review every clinical page before launch — GPhC hard gate.
...
GIT (St Marks): bc1aafc feat: one-tap booking email handler + memory protocol | 708c4d4 feat: wire booking form to email, add real phone/hours, fix footer link | 099a809 session: 2026-06-30 ÔÇö NHS + private pages and booking form
